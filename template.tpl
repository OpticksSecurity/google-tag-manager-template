...

{
  ...
  "categories": ["AFFILIATE_MARKETING", "ADVERTISING", "MARKETING", "CONVERSIONS"],
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "Opticks Anti ad-fraud lead and conversion reporting tag.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "LABEL",
    "name": "label",
    "displayName": "Opticks automatically captures UTM parameters along all other parameters in the URL. The following fields can be used to input data in Opticks that is not available in the URL Params (e.g. some values from the Data Layer)"
  },
  {
    "type": "TEXT",
    "name": "var1",
...
const id = copyFromWindow("optHitId");
